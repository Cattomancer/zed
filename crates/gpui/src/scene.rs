...
pub struct Scene {
    ...
    pub instanced_rects: Vec<InstancedRects>,
    pub instanced_lines: Vec<InstancedLines>,
}
...
pub enum PrimitiveBatch {
    ...
    InstancedRects(Range<usize>),
    InstancedLines(Range<usize>),
}
