...
impl<T: 'static> Reservation<T>
{
    ...
    pub fn entity_id(&self) -> EntityId { self.0.entity_id() }
}
...
where C: std::borrow::BorrowMut<App>
{
    fn set_global<G: Global>(&mut self, global: G) { self.borrow_mut().set_global(global) }
